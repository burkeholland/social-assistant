    ...
    <div class="columns">
      ...
      <div class="column">
        ...
        <div class="is-pulled-right">
          <button class="delete" @click="deleteMessage(message.id)" v-if="message.role === 'user'"></button>
          <button class="button" @click="copyMessage(message.contentPlain)" v-if="message.role === 'assistant'"
